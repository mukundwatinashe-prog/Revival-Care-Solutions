        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
            ...
            <a 
              ...
              className="group"
            >
              <div className="relative w-full h-32 bg-white rounded-3xl shadow-xl flex items-center justify-center border-2 border-primary-200 ring-4 ring-primary-100 p-6 overflow-hidden hover:shadow-2xl transition-all">
                <img
            ...
            <div className="group">
              <div className="relative w-full h-32 bg-white rounded-3xl shadow-xl flex items-center justify-center border-2 border-primary-200 ring-4 ring-primary-100 p-6 overflow-hidden">
                <Image
