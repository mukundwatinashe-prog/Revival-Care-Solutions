...
const services = [
  ...
  },
  {
    ...
    shortDescription: 'Heating and serving meals as directed by the client or family, using oven or microwave.',
    fullDescription: 'We prepare and serve meals exactly as instructed by the client or their family, using oven or microwave heating methods to ensure your loved one enjoys their food safely.',
    features: [
