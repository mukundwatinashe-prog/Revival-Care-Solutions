...
const servicesData: Record<string, ServiceData> = {
  ...
  'meal-preparation': {
    ...
    features: [
      ...
      'Snack preparation as instructed',
      'Ensuring safe food handling',
    ],
    benefits: [
      { title: 'Family Control', description: 'You decide what meals are prepared - we follow your instructions exactly.' },
      { title: 'Safe Preparation', description: 'Proper heating and serving ensures meals are enjoyed safely.' },
